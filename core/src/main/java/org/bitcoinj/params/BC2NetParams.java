 ...
 */
public class BC2NetParams extends AbstractBitcoinNetParams {
    static String PAYMENT_PROTOCOL_ID_BC2NET = "bc2";
    public static final int BC2NET_MAJORITY_WINDOW = 1000;
    public static final int BC2NET_MAJORITY_REJECT_BLOCK_OUTDATED = 950;
    public static final int BC2NET_MAJORITY_ENFORCE_BLOCK_UPGRADE = 750;

    public BC2NetParams() {
        super();
        targetTimespan = 60 * 60; // 1 hour
        interval = 60; // 1 minute
        //maxTarget = Utils.decodeCompactBits(0x1d7fffff); //check
        // is the value of maxTarget = 3450872762019142563415867392396217086887928240401226869186296274747392


        //BigInteger maxTarg = new BigInteger("9223372036854775807");
        //Shoving large integer into BigInteger

        BigInteger maxTarg = new BigInteger("0000007fffffffffffffffffffffffffffffffffffffffffffffffffffffffff",16);
        maxTarget = maxTarg;
        dumpedPrivateKeyHeader = 128;
        addressHeader = 25; //PUBKEY_ADDRESS
        p2shHeader = 28; //SCRIPT_ADDRESS
        acceptableAddressCodes = new int[] { addressHeader, p2shHeader };
        port = 8444;// TestNET=18332, MAIN=8442
        packetMagic = 0xeaafa5ca; //in BC2Params
        bip32HeaderPub = 0x0588B21E; //The 4 byte header that serializes in base58 to "xpub".
        bip32HeaderPriv = 0x0588ADE4; //The 4 byte header that serializes in base58 to "xprv"

        majorityEnforceBlockUpgrade = BC2NET_MAJORITY_ENFORCE_BLOCK_UPGRADE;
        majorityRejectBlockOutdated = BC2NET_MAJORITY_REJECT_BLOCK_OUTDATED;
        majorityWindow = BC2NET_MAJORITY_WINDOW;

        genesisBlock.setDifficultyTarget(0x1d7fffff); // from email, new working version
        genesisBlock.setTime(1483467305);
        genesisBlock.setNonce(53745805);
        //   genesis = CreateGenesisBlock(1483467305, 53745805, 0x1d7fffff,
        //1, 50 * COIN);
        id = "bc2";
        subsidyDecreaseBlockCount = 210000;
        spendableCoinbaseDepth = 10;
        String genesisHash = genesisBlock.getHashAsString();
        checkState(genesisHash.equals("0000000aaef3f699d6417fb8491c92871154aed8908803453d7336e3c2a3ed71"),
                genesisHash);
        ...
        checkpoints.put(0, Sha256Hash.wrap("0000000aaef3f699d6417fb8491c92871154aed8908803453d7336e3c2a3ed71"));
        /*
        The checkpoint for the genesis block



        CHECKPOINTS received from chainparams.cpp. Original from bitcoinj are comment below
        ...
        */
        ...
        dnsSeeds = new String[] {
                ...
                "172.16.120.201", // dnsSeeds from BC2Params
                "172.16.130.201",
                "67.205.138.199"
        };
        ...
        /*
        These are the IP Addresses set as the addrSeeds
        172.16.120.201
        172.16.130.201
        67.205.138.199
        */
        addrSeeds = new int[] {
                0xAC1078C9, 0xAC1082C9, 0x43CD8AC7,
        };
    }

    private static org.bitcoinj.params.BC2NetParams instance;
    public static synchronized org.bitcoinj.params.BC2NetParams get() {
        if (instance == null) {
            instance = new org.bitcoinj.params.BC2NetParams();
        }
        return instance;
    }
    ...
    public String getPaymentProtocolId() {
        return PAYMENT_PROTOCOL_ID_BC2NET;
    }
}
...
//package de.schildbach.wallet.BC2Params;
//
//import org.bitcoinj.core.ECKey;
//import org.bitcoinj.core.Sha256Hash;
//import org.bitcoinj.core.Utils;
...
//    }
//
//    private static de.schildbach.wallet.BC2NetParams instance;
//    public static synchronized de.schildbach.wallet.BC2NetParams get() {
//        if (instance == null) {
//            instance = new de.schildbach.wallet.BC2NetParams();
//        }
//        return instance;
//    }
//
